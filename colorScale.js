...
const colorScales = [
    {
      ...
      base: "#004c6d",
      shades: [
        "#f1fafd", "#d1eef9", "#a5dbf4", "#69bbe3", "#369ac8", "#1c6f9d",
        "#004c6d", "#003348", "#002132", "#00131c",
      ],
    },
    {
      name: "red",
      base: "#8e0b0b",
      shades: [
        "#fde8e8", "#fac3c3", "#f59393", "#e85b5b", "#d72f2f", "#b31a1a",
        "#8e0b0b", "#5d0505", "#3c0202", "#220000",
      ],
    },
    {
      name: "green",
      base: "#1b7f27",
      shades: [
        "#eafbe7", "#c5efc2", "#96e394", "#4ebf5c", "#23a633", "#188a27",
        "#1b7f27", "#0b5118", "#04320e", "#001d05",
      ],
    },
    {
      name: "orange",
      base: "#d15c1e",
      shades: [
        "#fef5ec", "#fbdcc5", "#f6b693", "#ef8147", "#e5581a", "#c04612",
        "#d15c1e", "#84350b", "#4c1d06", "#261103",
      ],
    },
    {
      name: "purple",
      base: "#60298e",
      shades: [
        "#f5ecfc", "#e3d1f7", "#c5a5ed", "#a869e0", "#8939d0", "#60298e",
        "#482069", "#2c1340", "#170920", "#0a0410",
      ],
    },
    {
      name: "yellow",
      base: "#d8b31f",
      shades: [
        "#fffde7", "#fff5b5", "#ffec6b", "#ffdf23", "#f7c404", "#d8b31f",
        "#a1840d", "#604b07", "#362903", "#1d1601",
      ],
    },
    {
      name: "pink",
      base: "#cc337d",
      shades: [
        "#fdebf2", "#f9c7dd", "#f399bb", "#ea5f90", "#db3472", "#b1265a",
        "#cc337d", "#822047", "#4c132a", "#270a16",
      ],
    },
    {
      name: "teal",
      base: "#206d6b",
      shades: [
        "#e9fafa", "#c1eded", "#8bd6d6", "#47b8b7", "#239f9e", "#1d7c7c",
        "#206d6b", "#124847", "#082727", "#041515",
      ],
    },
    {
      name: "brown",
      base: "#7a5230",
      shades: [
        "#f8f2ec", "#eedccc", "#e1bfa0", "#d19c6e", "#bb7642", "#8f5a2f",
        "#7a5230", "#4e341f", "#2e1f12", "#17100a",
      ],
    },
    {
      name: "gray",
      base: "#5c5c5c",
      shades: [
        "#f9f9f9", "#ececec", "#c7c7c7", "#9a9a9a", "#757575", "#5c5c5c",
        "#3a3a3a", "#202020", "#111111", "#000000",
      ],
    },
  ];
